...
if __name__ == "__main__":
    ...
    # 输入文件
    # (原始的、包含所有站点的 NC 文件)
    nc_file = os.path.join(base_dir, "Combine_Stations_ExMaxWind_Fixed.nc")
    
    # (用于决策的质量报告)
    csv_quality_report = os.path.join("/Users/momo/Desktop/业务相关/2025 影响台风大风/数据/4_合并后_区分缺测类型_按站点.csv")
    
    # 输出文件
    # (你想要的、精简后的新 NC 文件名)
    output_nc_file = os.path.join(base_dir, "Refined_Combine_Stations_ExMaxWind_Fixed.nc")
